  ...
  return (
    ...
    >
      ...
      <div className="container" style={{ marginBottom: '-3%' }}>
          ...
          >
            ...
            >
              <img 
                ...
                className="w-full h-auto object-cover bg-transparent border-none shadow-none scale-[0.8] md:scale-[0.6] transition-transform duration-300"
              />
            </motion.div>
        ...
        <div className="md:hidden mt-8 mb-20 relative z-30">
