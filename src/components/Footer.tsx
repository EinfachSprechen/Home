      ...
      <div className="container">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/4367761769787" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-green-600 transition-colors">
          ...
          <div id="contact">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg w-fit"
              >
                <Send size={20} />
        ...
        <div className="pt-8 border-t border-gray-200 text-center text-gray-500 text-sm">
          <p className="flex items-center justify-center gap-1">
            {t('footer.createdWith')} <Heart size={16} className="text-pink-500" /> {t('footer.createdFor')}
          </p>
          <p className="mt-2">
            © {currentYear} Einfach Sprechen. {t('footer.copyright')}
          </p>
        </div>
      </div>
    </footer>
